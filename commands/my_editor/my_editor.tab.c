...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MY_EDITOR = 3,                  /* MY_EDITOR  */
  YYSYMBOL_ARG = 4,                        /* ARG  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "MY_EDITOR", "ARG",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: MY_EDITOR NEWLINE  */
#line 34 "my_editor.y"
      { 
        fprintf(stderr, "Usage: my_editor <filename>\n"); 
      }
#line 1071 "my_editor.tab.c"
    break;

  case 5: /* line: MY_EDITOR ARG NEWLINE  */
#line 38 "my_editor.y"
      { 
        run_my_editor((yyvsp[-1].str)); 
        free((yyvsp[-1].str));
      }
#line 1080 "my_editor.tab.c"
    break;


#line 1084 "my_editor.tab.c"
