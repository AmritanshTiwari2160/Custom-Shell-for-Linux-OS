...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_AM_LAUNCH = 3,                  /* AM_LAUNCH  */
  YYSYMBOL_ARG = 4,                        /* ARG  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "AM_LAUNCH", "ARG",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: AM_LAUNCH NEWLINE  */
#line 36 "am_launch.y"
        { 
          fprintf(stderr, "Usage: am_launch <application>\n"); 
        }
#line 1073 "am_launch.tab.c"
    break;

  case 5: /* line: AM_LAUNCH ARG NEWLINE  */
#line 40 "am_launch.y"
        { 
          run_am_launch((yyvsp[-1].str)); 
          free((yyvsp[-1].str)); 
        }
#line 1082 "am_launch.tab.c"
    break;


#line 1086 "am_launch.tab.c"
