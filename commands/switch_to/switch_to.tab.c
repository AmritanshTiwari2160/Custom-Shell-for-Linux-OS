...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SWITCH_TO = 3,                  /* SWITCH_TO  */
  YYSYMBOL_ARG = 4,                        /* ARG  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "SWITCH_TO", "ARG",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: SWITCH_TO NEWLINE  */
#line 47 "switch_to.y"
        { run_switch_to("."); }
#line 1082 "switch_to.tab.c"
    break;

  case 5: /* line: SWITCH_TO ARG NEWLINE  */
#line 49 "switch_to.y"
        { run_switch_to((yyvsp[-1].str)); free((yyvsp[-1].str)); }
#line 1088 "switch_to.tab.c"
    break;


#line 1092 "switch_to.tab.c"
