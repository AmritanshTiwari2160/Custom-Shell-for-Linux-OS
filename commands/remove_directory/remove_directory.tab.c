...
#line 141 "remove_directory.tab.c"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_REMOVE_DIRECTORY = 3,           /* REMOVE_DIRECTORY  */
  YYSYMBOL_ARG = 4,                        /* ARG  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "REMOVE_DIRECTORY",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: REMOVE_DIRECTORY NEWLINE  */
#line 88 "remove_directory.y"
        { run_remove_dir("."); }
#line 1123 "remove_directory.tab.c"
    break;

  case 5: /* line: REMOVE_DIRECTORY ARG NEWLINE  */
#line 90 "remove_directory.y"
        { run_remove_dir((yyvsp[-1].str)); free((yyvsp[-1].str)); }
#line 1129 "remove_directory.tab.c"
    break;


#line 1133 "remove_directory.tab.c"
